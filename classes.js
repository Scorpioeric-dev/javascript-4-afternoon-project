...
/*
  ...
  class Employee {
    constructor(first_name,last_name,email,age){
      ...
      makeWidget(){
        return first_name + this.last_name + `Widget`
      }
    }
...
class ProgressiveManager extends Manager{
  constructor(first_name,last_name,email,age,reports,fire){
    super(first_name,last_name,email,age,reports,fire)
